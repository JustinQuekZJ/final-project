    ...
    function updateMap(option) {
        ...
        switch (option) {
            ...
            case 'MajCrime':
                ...
                colorStops = [36, 100, 200, 400, 600, 800, 1000, 1211];
                colorRange = [
                    'rgba(222, 222, 222, 1)',
                    'rgba(253, 223, 104, 1)',
                    'rgba(248, 191, 97, 1)',
        ...
        // Log the fill color expression to check if it's constructed correctly
        console.log('Fill color array:', fillColorExpression);
